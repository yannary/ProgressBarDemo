...
public class CircleProgressBar extends View {
    ...
    public CircleProgressBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        roundProgressColor = mTypedArray.getColor(R.styleable.CircleProgressBar_roundProgressColor, Color.BLUE);
        textColor = mTypedArray.getColor(R.styleable.CircleProgressBar_textColor, Color.BLUE);

        topTextSize = mTypedArray.getDimension(R.styleable.CircleProgressBar_topTextSize, 18);
        bottomTextSize = mTypedArray.getDimension(R.styleable.CircleProgressBar_bottomTextSize, 15);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paint.setTypeface(Typeface.DEFAULT); //设置字体DEFAULT_BOLD
        ...
        float bottomTextWidth = paint.measureText(bottomText);
        if (textIsDisplayable && !TextUtils.isEmpty(bottomText) && style == STROKE) {
            canvas.drawText(bottomText, centre - bottomTextWidth / 2, centre + 3 * bottomTextSize / 2, paint); //画出底部文字
        }
        /**
         * 画圆弧 ，画圆环的进度
         */
     ...
     * @param progress
     */
    public synchronized void setProgress(int progress, String bottomText) {
